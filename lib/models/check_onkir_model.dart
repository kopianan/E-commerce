class CheckOngkirModel {
  ...
  CheckOngkirModel({this.rajaongkir});

  CheckOngkirModel.fromJson(Map<String, dynamic> json) {
...
class Rajaongkir {
  ...
  Rajaongkir.fromJson(Map<String, dynamic> json) {
    ...
    destinationDetails = json['destination_details'] != null
        ? new DestinationDetails.fromJson(json['destination_details'])
        : null;
...
class Query {
  ...
  Query({this.key, this.origin, this.destination, this.weight, this.courier});
