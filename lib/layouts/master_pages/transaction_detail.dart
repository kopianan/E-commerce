...
class _TransactionDetailState extends State<TransactionDetail> {
                ...
                case ConnectionState.done:
                  if (snapshot.hasData) {
                    ...
                    return buildCustomScrollView(
                        snapshot.data, selected.selectedTransactionDetail);
                  } else {
  ...
  CustomScrollView buildCustomScrollView(
      List<DetailTransactionModel> data, AllTransactionListModel transDetail) {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                        'Rp. ${Fun().formatStringCurrency(transDetail.totalAmount)}',
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text("Sub total untuk produk",
                          style: TextStyle(fontSize: 16)),
                      Text(
                          "Rp. ${Fun().formatStringCurrency((int.parse(double.parse(transDetail.totalAmount).toStringAsFixed(0)) - int.parse(double.parse(dataOngkir.subTotal).toStringAsFixed(0))).toString())}",
                          style: TextStyle(fontSize: 16)),
                    ],
                  ),
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          "Rp. ${Fun().formatStringCurrency(dataOngkir.subTotal)}",
                          style: TextStyle(fontSize: 16)),
                    ],
                  ),
                ],
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                      '${dataUser.address}, ${dataUser.city}, ${dataUser.province}'),
                ],
              ),
            ),
          ],
        ...
        child: Row(
          children: <Widget>[
            Padding(
              ...
              child:
              FadeInImage(image: NetworkImage('http://datacloud.erp.web.id:8081${data[index].itemPicture}'), placeholder: AssetImage('assets/broken_image.png'), fit: BoxFit.cover,),
            ),
            SizedBox(width: 4.0),
            Expanded(
              child: Column(
